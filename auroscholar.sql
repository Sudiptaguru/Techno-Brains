...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2021 at 05:36 PM
...
(7, 'lorem ipsum', 'SMS', 'lorem ipsum', '1', 16, 1, 9, '2021-09-14 04:03:07', '2021-09-14 04:21:20'),
...
--
ALTER TABLE `auro_partner_master`
  MODIFY `partner_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `com_template_master`
  MODIFY `com_template_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `partner_user_mapping`
  MODIFY `partner_user_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
